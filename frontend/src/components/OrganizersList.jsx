    ...
    <section id="recommended-events" className="py-10 md:py-12 w-full flex flex-col items-center justify-center shadow-inner-lg bg-secondary">
      <div className="w-[90%] lg:w-[80%] xl:w-[75%] 2xl:w-[60%] font-outfit">
        <div className="flex flex-row w-full items-end justify-between">
          ...
          {organizers.length > 5 && (
            <button className='bg-gray-200 font-medium px-4 py-2 rounded-lg cursor-pointer hidden md:flex items-center gap-2'>View All <FaArrowRight /></button>
          )}
        </div>
        ...
        {organizers.length >= 5 && (
          <div className="text-center mt-10 md:hidden w-full flex items-center justify-center">
            <Link
              to="/Events"
