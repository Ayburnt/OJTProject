...
const Attendees = () => {
    const { userCode } = useParams(); // get userCode from URL
    ...
    useEffect(() => {
        const fetchOrganizerEvents = async () => {
            try {
                ...
                setEventsError(
                    "Failed to fetch events. Check network or Django server."
                );
    ...
    const filteredAttendees = attendees.filter(
        (a) =>
            a.name?.toLowerCase().includes(searchAttendees.toLowerCase()) ||
