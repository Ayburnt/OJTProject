...
const Attendees = () => {
  ...
  const events = ['All Events', 'Corporate', 'Social', 'Cultural', 'Sports & Recreational', 'Political & Government', 'Educational', 'Fundraising',];
  const attendees = [];
    ...
    <div className="bg-gray-50 min-h-screen font-sans">
      ...
      <div className="pt-23 md:ml-64 p-4 md:p-8 lg:p-12 flex flex-col items-center">
        ...
        <div className="w-full max-w-6xl mx-auto p-5 md:p-8 lg:p-10 border border-gray-300 rounded-xl shadow bg-white">
          <h1 className="text-2xl font-semibold text-gray-800 mb-10">Manage Event Attendees</h1>
            ...
            <div className="flex flex-col gap-3 w-full lg:flex-row lg:items-end lg:w-auto">
              ...
              <div className="flex flex-col w-full lg:w-52">
                ...
                <div className="relative">
                  ...
                  <FaChevronDown className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-gray-400" size={14} />
                </div>
              </div>
              ...
              <div className="flex w-full justify-end md:justify-end">
                <button
                  onClick={downloadCsv}
                  className="min-w-[200px] whitespace-nowrap py-2 px-4 text-sm bg-teal-600 hover:bg-teal-700 text-white font-medium rounded-md transition-all flex justify-center items-center cursor-pointer"
                >
            ...
            <table className="w-full border-t border-black text-center">
              <thead>
                <tr className="text-gray-600 text-sm border-b border-black">
                  <th className="py-3 px-4 font-medium border border-black">NAME</th>
                  <th className="py-3 px-4 font-medium border border-black">EMAIL</th>
                  <th className="py-3 px-4 font-medium border border-black">EVENT</th>
                  <th className="py-3 px-4 font-medium border border-black">REG. DATE</th>
                  <th className="py-3 px-4 font-medium border border-black">TICKET TYPE</th>
                </tr>
              </thead>
              <tbody>
                {filteredAttendees.length > 0 ? (
                  filteredAttendees.map((a, idx) => (
                    <tr key={idx} className={`text-sm ${idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'} hover:bg-gray-100 transition`}>
                      ...
                      <td className="py-3 px-4 border border-black">{a.ticketType}</td>
                    </tr>
                  ))
                ) : (
                  <tr>
                    <td colSpan="5" className="py-6 text-center text-gray-500 italic">No attendees found.</td>
                  </tr>
                )}
              </tbody>
            </table>
