            ...
            <div className="bg-white rounded-lg shadow-lg w-[90%] max-w-md h-auto lg:h-screen flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto">
                <div className="px-6 pb-4 divide-y divide-gray-200 text-sm">
                  ...
                  <div className="flex justify-between py-2">
                    <span className="text-gray-500">Check-in By:</span>
                    <span className="text-gray-800 font-medium">
                    ...
                    <ul className="space-y-2">
                      {selectedAttendee.responses.map((resp, idx) => (
                        <li key={idx} className="border-b pb-2">
                          <p className="text-gray-800 font-medium">{resp.question_details?.question_label}</p>
                          <p className="text-gray-500 text-sm">{resp.response_value || "No response"}</p>
                        </li>
                      ))}
                    </ul>
                  </div>
